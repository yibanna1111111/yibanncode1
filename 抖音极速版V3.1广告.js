...
let stoptims = "15";          //看广告超指定时间停止   填写注意：1代表1分钟，3代表3分钟
// ================================== 脚本版本参数 =================================== \\
...
// ============================================执行项目============================================ \\
    ...
    async two_moread(aggrincomeid,timeout = 1000) {
        return new Promise((resolve) => {
            let url = {
                url: `${hostname}/luckycat/aweme/v1/task/done/excitation_ad/one_more?${this.ck[0]}`,
                headers: {
                ...
                try {
                    ...
                    if (result == true) {
                        ...
                        if (result.err_no == 0) {
                            ...
                            await this.two_moread(aggrincomeid,2 * 1000);
                        }
                    } else {
                        await this.two_moread(aggrincomeid,2 * 1000);
                    }
                ...
                try {
                    ...
                    if (result == true) {
                        ...
                        if (result.err_no == 0) {
                            ...
                            await this.three_moread(aggrincomeid,2 * 1000);
                        }
                    } else {
                        await this.three_moread(aggrincomeid,2 * 1000);
                    }
